...
* **10:00 مساءً (الإغلاق القومي للوزارة):** الإغلاق النهائي والاعتماد الوزاري للتقرير القومي الموحد لليوم.
...
| **الوزارة: رئيس القطاع والوزير** | رئيس القطاع / معالي الوزير | اعتماد التقرير القومي النهائي الشامل | صلاحية استثنائية سيادية | صلاحية الفتح المركزي العام (Master Override) |
...
* **التنسيق:** `Tailwind CSS` (مع الالتزام بالهوية: كحلي سيادي `#0F172A`، أزرق صحي `#0284C7`، أخضر الحماية `#16A34A`، وأحمر الإغلاق `#DC2626`).
